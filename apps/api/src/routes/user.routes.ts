...
router.delete('/me', validate(z.object({ body: z.object({ password: z.string().min(1).max(128) }).strict(), query: z.any(), params: z.any() })), asyncHandler(userController.deleteAccount));
