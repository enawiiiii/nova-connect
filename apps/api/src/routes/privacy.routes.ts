...
router.post('/reports', validate(z.object({ body: z.object({ userId: id, reason: z.enum(['spam', 'harassment', 'impersonation', 'unsafe', 'other']), details: z.string().max(1000).optional() }).strict(), params: z.any(), query: z.any() })), asyncHandler(privacyController.report));
