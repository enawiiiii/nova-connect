...
const resources = {
  en: { translation: {
    ...
    auth: { welcome: 'Welcome back', join: 'Join your orbit', loginBody: 'Your people are already here.', registerBody: 'Create a private space for your closest people.', username: 'Username', email: 'Email address', password: 'Password', login: 'Sign in', register: 'Create account', noAccount: 'New to {{productShortName}}?', hasAccount: 'Already have an account?', create: 'Create one', signIn: 'Sign in', google: 'Continue with Google', divider: 'or continue with email' },
    ...
    settings: { title: 'Settings', subtitle: 'Make {{productShortName}} feel like yours', appearance: 'Appearance', dark: 'Deep space', light: 'Soft light', language: 'Language & direction', notifications: 'Notifications', notifBody: 'Messages, friend requests, and incoming calls', privacy: 'Privacy & security', privacyBody: 'Manage sessions and blocked accounts', install: 'Install {{productName}}', installBody: 'Add the app to this device for a faster, focused experience', installAction: 'Install app', signout: 'Sign out' },
...
void i18n.use(initReactI18next).init({
  ...
  interpolation: {
    escapeValue: false,
    defaultVariables: { productName: product.name, productShortName: product.shortName },
  },
});
